...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color: rgb(207, 190, 255);")
        ...
        self.MIX_RATIO.setGeometry(QtCore.QRect(170, 80, 461, 51))
...
"color: rgb(255, 85, 127);")
        ...
        self.MIX_RATIO.setPageStep(1)
        self.MIX_RATIO.setProperty("value", 100)
        self.MIX_RATIO.setOrientation(QtCore.Qt.Horizontal)
        self.MIX_RATIO.setTickInterval(0)
        self.MIX_RATIO.setObjectName("MIX_RATIO")
        self.RATIO = QtWidgets.QLabel(self.centralwidget)
        self.RATIO.setGeometry(QtCore.QRect(390, 130, 81, 31))
        ...
        self.resultsTable.setCornerButtonEnabled(True)
